        ...
        <div class="container-fluid">
            <div class="row menu">
                <?php require_once 'menu.php';?>
                             ...
                             <div class="row">
                                 <form class="form-horizontal col-sm-6" method="POST" action="enregister_access.php">
  <legend>Ajouter un équipement Access2:</legend>
  <div class="row">
                <div class="form-group">
                    <label for="serie" class="col-sm-3">Num de série: </label>
                    <div class="col-sm-9">
                        <input type="number" placeholder="201825" name="serie" id="serie" min="100000" max="999999" class="form-control">    
                </div>
                </div> 
                </div> 
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-9">
                     <input type="text" placeholder="3.4.1" name="soft" id="soft" class="form-control">
                </div>
                </div>  
                </div>
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" placeholder="169.2.172.2" name="apf" id="apf" class="form-control">
                </div>
                </div>  
                </div>
