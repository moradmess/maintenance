...
if(!isset($_SESSION['ADMIN']) || !isset($_SERVER['HTTP_REFERER']) || empty($_GET['code']) || !is_int_positive($_GET['code'])) {
    ...
    $info = new Access(array('idmpa' => $_GET['code']));
    $donnee_a_modifie = $info->chercher_code('mp_a'); 
...
<html>
        ...
        <div class="container-fluid">
            <div class="row menu">
                <?php require_once 'menu.php';?>
                             ...
                             <div class="row">
                                 <form class="form-horizontal col-sm-6" method="POST" action="modifier_mp_access2_program.php?info=modif">
        <legend>Modifier les dates MP Access2:</legend>
               <div class="row">
    ...
    <div class="row">
                <div class="form-group">
                     <label for="apf" class="col-sm-3">APF: </label>
                     <div class="col-sm-9">
                         <input type="text" name="apf" id="apf" value="<?php echo $_SESSION['DM_INFO']['apf']; ?>" class="form-control" disabled>
                </div>
                </div>  
                </div>
  ...
  <div class="row">
                ...
                <div class="form-group">
                     <label for="contrat" class="col-sm-3 ppp1">Contrat: </label>
                     <div class="col-sm-9">
...
<div class="modal-body">
    ...
    <form class="form-horizontal" method="POST" action="modifier_mp_access2_program.php?info=enreg">
    	                <div class="row">
                <div class="form-group">
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-6">
                         <select name="nom_interv" onChange="surface();" id="nom_interv" class="form-control">
                            ...
                            <option>Aziz Chakir</option>
                            <option>Yassir</option>
                            <option>Jawad Ettouhami</option>
                            <option>Jihad</option>
                        </select>
                </div>     
                </div>  
