...
if(empty($_SESSION['ADMIN']) || !isset($_SERVER['HTTP_REFERER']) || empty($_GET['code']) || !is_int_positive($_GET['code'])) {
    ...
    $info = new Access(array('iddma' => $_GET['code']));
    $donnee_a_modifie = $info->chercher_code('dm_a');
...
<html>
       ...
       <div class="container-fluid">
            <div class="row menu">
                <?php require_once 'menu.php';?>
                             ...
                             <div class="row">
                                 <form class="form-horizontal col-sm-6" method="POST" action="modifier_dm_access2_program.php">
   <legend>Modifier les données Access2:</legend>
                                <div class="row">
                <div class="form-group">
                    <label for="serie" class="col-sm-3">Num de série: </label>
                    <div class="col-sm-9">
                        <input type="number" name="serie" id="serie" value="<?php echo $_SESSION['DM_INFO']['serial_number']; ?>" class="form-control" readonly=TRUE>    
                </div>
                </div> 
                </div> 
  ...
  <div class="row">
                <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" name="apf" id="apf" value="<?php echo $_SESSION['DM_INFO']['apf']; ?>" class="form-control">
                </div>
                </div>  
                </div>
