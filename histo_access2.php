...
<html>
    <head>
        ...
        <title>Historique Access2</title>
         <style>
        th
        {
    ...
    <body>
        <div class="container-fluid">
           ...
           <div id="barre_cherche" class="row">
                ...
                <form class="form-horizontal visible-xs col-xs-12 well" method="GET" action="histo_access2.php">
                  ...
                  <form method="GET" action="histo_access2.php">
                ...
                <form id="form_recherche" method="GET" action="histo_access2.php">
                ...
                <div id="bt_wei">
                    <div class="row">
                        ...
                        <a id="bt_excel" href="excel_histo_access2.php?excel"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Excel</button></a>    
                    <a id="bt_word" href="excel_histo_access2.php?word"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>
                    </div>
                </div>
            </div>
...
//faire des recherches
    ...
    {     //pour le javascript      
         ...
         $donnee = $mode->chercher("historique",$_GET['mode']); 
        ...
        if($nb_ligne == 0)
        {
            ...
            echo '<caption><h4>Historique MP Access2: (Nombre total: '.$nb_ligne.')</h4></caption>';
                echo '<thead><tr><th>Num de série</th><th>Version software</th><th>APF</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th><th>Date d\'intervention</th><th>Nom intervenant</th><th>Detail</th></tr></thead>';
    echo '<tbody>';
    ...
    //on n'affecte pas de recherche 
        ...
        $nbLigne_total = Access::afficher_NbLigne("historique");
    ...
    echo '<caption><h4>Historique MP Access2: (Nombre total: '.$nbLigne_total.')</h4></caption>';
    echo '<thead><tr><th>Num de série</th><th>Version software</th><th>APF</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th><th>Date d\'intervention</th><th>Nom intervenant</th><th>Detail</th></tr></thead>';
    $donnee = (isset($_GET['trier'])) ? Access::afficher_equip_trier($nombre_ligne_affiche, $decalage, $_GET['trier'], "historique") : Access::afficher_equip($nombre_ligne_affiche, $decalage, "historique");
    $nb_ligne = count($donnee);
    echo '<tbody>';
    for ($i = 0; $i < $nb_ligne; $i++)
    {
       ...
       <?php
            ...
            ?>
                ...
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
            <?php }
            else {  ?> 
            <div id="footer" class="row">
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="histo_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="histo_access2.php?lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
            <?php }
            ?>
         <script>
    document.getElementById('historique').className = 'active';
