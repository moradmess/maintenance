...
//$code_id_sup = (isset($_GET['code'])) ? (int) $_GET['code'] : 0;
...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div id="barre_cherche" class="row">
                <form class="form-inline hidden-sm hidden-xs pull-left well" method="GET" action="mp_au.php">
            ...
            <a href="excel_mp_au.php?word"><button type="submit" class="btn btn-warning" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>    
                ...
                <form class="form-inline visible-sm visible-xs pull-left well" method="GET" action="mp_au.php">
            ...
            <a href="excel_mp_au.php?excel"><button type="submit" class="btn btn-warning btn-sm" name="export_excel"><span class="glyphicon glyphicon-export"></span> Excel</button></a>
            <a href="excel_mp_au.php?word"><button type="submit" class="btn btn-warning btn-sm" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>    
                </div>
            ...
            <a href="excel_mp_au.php?excel"><button type="submit" class="col-xs-3 col-xs-offset-1 btn btn-warning btn-sm" name="export_excel"><span class="glyphicon glyphicon-export"></span> Excel</button></a>
            <a href="excel_mp_au.php?word"><button type="submit" class="col-xs-3 col-xs-offset-1 btn btn-warning btn-sm" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>    
                </div>
            </div>
    ...
    {     //pour le javascript      
        ...
        echo '<caption><h4>Planning MP des AU: (Nombre total: '.$nb_ligne.')</h4></caption>';
        echo '<thead><tr><th>ISE</th><th>Num de série</th><th>Version software</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th><th>Date Dernière MP</th><th>Date MP Prévue</th><th id="temps">Temps Resté</th></tr></thead>';
    echo '<tbody>';
    ...
    echo '<td id="bt_modifier"><a href="modifier_mp_au.php?code='.$donnee[$i][9].'"><abbr title="éditer"><button id="bt_modif" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span></button></abbr></a></td>';
    ...
    echo '</tbody>';
        ...
        $nbLigne_total = AU::afficher_NbLigne("maintenance");
    ...
    echo '<caption><h4>Planning MP des AU: (Nombre total: '.$nbLigne_total.')</h4></caption>';
    echo '<thead><tr><th>ISE</th><th>Num de série</th><th>Version software</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th><th>Date Dernière MP</th><th>Date MP Prévue</th><th id="temps">Temps Resté</th></tr></thead>';
    $donnee = AU::afficher_equip($nombre_ligne_affiche, $decalage, "maintenance");
    $nb_ligne = count($donnee);
    echo '<tbody>';
    for ($i = 0; $i < $nb_ligne; $i++)
    {
...
<div class="modal-body">
    ...
    <div class="modal-footer">
        <a href="supprimer_mp_au.php?code=<?php echo $_GET['code']; ?>"><button type="submit" class="btn btn-danger" id="modifier">Oui</button></a>
        <button class="btn btn-info" data-dismiss="modal" id="momo">Non</button>
                ...
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="mp_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="mp_au.php?lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="mp_au.php?lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="mp_au.php?lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="mp_au.php?lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
        </div>
         <script>
