...
<html>
    <head>
        ...
        @media print
        {
            #barre_cherche, #footer, #bt_modifier, #ajouterdm, caption
                {
                   display: none;
                }
        }
    ...
    <body>
        <div class="container-fluid">
            ...
            <div id="barre_cherche" class="row">
                ...
                <form class="form-horizontal visible-xs col-xs-12 well" method="GET" action="dm_access2.php">
                  ...
                  <form method="GET" action="dm_access2.php">
                ...
                <form id="form_recherche" method="GET" action="dm_access2.php">
                ...
                <div id="bt_wei">
                    <div class="row">
                        ...
                        <a id="bt_excel" href="excel_dm_access2.php?excel"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Excel</button></a>
                    <a id="bt_word" href="excel_dm_access2.php?word"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>
                    </div>
                </div>
            </div>
...
<?php
    ...
    {     //pour le javascript      
         ...
         $donnee = $mode->chercher("equipement", $_GET['mode']); 
        ...
        echo '<caption><h4>Access2 : (Nombre total: '.$nb_ligne.')</h4></caption>';
        echo '<thead><tr><th>Num de série</th><th>Etat</th><th>Version software</th><th>APF</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th>';
       if(isset($_SESSION['ADMIN'])) echo '<td id="ajouterdm"><a href="ajout_dm_access.php"><button id="bt_ajout" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil">Ajout</span></button></a></td></tr></thead>';
       else echo '</tr></thead>';
       echo '<tbody>';
    ...
    echo '<td id="bt_modifier"><a href="modifier_dm_access2.php?code='.$donnee[$i][8].'"><button id="bt_modif" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit">édit</span></button></a></td>';
        }
    echo '</tr>';
    }
    echo '</tbody>'; 
    ...
    {  
        ...
        $nbLigne_total = Access::afficher_NbLigne("equipement");
    ...
    echo '<caption><h4>Nombre total des Access2: '.$nbLigne_total.' (Active: '.Access::Active_inactive('Access2','Active').' Inactive: '.Access::Active_inactive('Access2','Inactive').')</h4></caption>';
    echo '<thead><tr><th>Num de série</th><th>Etat</th><th>Version software</th><th>APF</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th>';
     if(isset($_SESSION['ADMIN'])) echo '<td id="ajouterdm"><a href="ajout_dm_access.php"><button id="bt_ajout" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil">Ajout</span></button></a></td></tr></thead>';
    else echo '</tr></thead>';
    $donnee = (isset($_GET['trier'])) ? Access::afficher_equip_trier($nombre_ligne_affiche, $decalage, $_GET['trier'], "equipement") : Access::afficher_equip($nombre_ligne_affiche, $decalage, "equipement");
    $nb_ligne = count($donnee);
    echo '<tbody>';
    for ($i = 0; $i < $nb_ligne; $i++)
    {
    ...
    <?php
            ...
            ?>
                ...
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
            <?php }
            else {  ?> 
            <div id="footer" class="row">
                <ul id="page_liste" class="pagination pull-left">
                <li id="first_button"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                <li id="seconde_button"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                <li id="button1"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                <li id="button2"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                <li id="button3"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                <li id="last_button"><a href="dm_access2.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_access2.php?lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
            <?php }
            ?>
