    ...
    <body>
        <div class="container-fluid">
            ...
            <div id="barre_cherche" class="row">
                ...
                <form class="form-horizontal visible-xs col-xs-12 well" method="GET" action="dm_au.php">
                  ...
                  <form method="GET" action="dm_au.php">
                ...
                <form id="form_recherche" method="GET" action="dm_au.php">
                ...
                <div id="bt_wei">
                    <div class="row">
                        ...
                        <a id="bt_excel" href="excel_dm_au.php?excel"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Excel</button></a>    
                    <a id="bt_word" href="excel_dm_au.php?word"><button type="submit" name="export_excel"><span class="glyphicon glyphicon-export"></span> Word</button></a>
                    </div>
                </div>
            </div>
...
//faire des recherches
    ...
    {     //pour le javascript      
         ...
         $nombre_de_page = 1;
         $nbLigne_total = 1;
         $mode = new AU(array($_GET['mode'] => $_GET['chercher']));
        ...
        if($nb_ligne == 0)
        {
            ...
            echo '<thead><tr><th>ISE</th><th>Num de série</th><th>Etat</th><th>Version software</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th>';
            if(isset($_SESSION['ADMIN'])) echo '<td id="ajouterdm"><a href="ajout_dm_au.php"><button id="bt_ajout" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil">Ajout</span></button></a></td></tr></thead>';
            else echo '</tr></thead>';
    echo '<tbody>';
    ...
    echo '<td id="bt_modifier"><a href="modifier_dm_au.php?code='.$donnee[$i][8].'"><button id="bt_modif" class="btn btn-success"><span class="glyphicon glyphicon-edit">édit</span></button></a></td>';
        }
    echo '</tr>';
    }
    echo '</tbody>'; 
    ...
    //on n'affecte pas de recherche 
        ...
        $nbLigne_total = AU::afficher_NbLigne("equipement");
    ...
    echo '<caption><h4>Nombre total des AU: '.$nbLigne_total.' (Active: '.AU::Active_inactive('AU','Active').' Inactive: '.AU::Active_inactive('AU','Inactive').')</h4></caption>';
    echo '<thead><tr><th>ISE</th><th>Num de série</th><th>Etat</th><th>Version software</th><th>Date d\'installation</th><th>Nom client</th><th>Ville</th><th>Contrat</th>';
    if(isset($_SESSION['ADMIN'])) echo '<td id="ajouterdm"><a href="ajout_dm_au.php"><button id="bt_ajout" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil">Ajout</span></button></a></td></tr></thead>';
    else echo '</tr></thead>';
    $donnee = (isset($_GET['trier'])) ? AU::afficher_equip_trier($nombre_ligne_affiche, $decalage, $_GET['trier'], "equipement") : AU::afficher_equip($nombre_ligne_affiche, $decalage, "equipement");
    $nb_ligne = count($donnee);
    echo '<tbody>';
    for ($i = 0; $i < $nb_ligne; $i++)
    {
    ...
    echo '<td>'.$donnee[$i][7].'</td>';  
    if(isset($_SESSION['ADMIN'])) {
    echo '<td id="bt_modifier"><a href="modifier_dm_au.php?code='.$donnee[$i][8].'"><button id="bt_modif" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit">édit</span></button></a></td>';
        }
    echo '</tr>';
    }
    echo '</tbody>'; 
       ...
       <?php
            ...
            ?>
                ...
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?trier=<?php echo $_GET['trier']; ?>&amp;lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            </div>
            <?php }
            else {  ?> 
            <div id="footer" class="row">
                <ul id="page_liste" class="pagination pull-left">
                    <li id="first_button"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=1"><<</a></li>
                    <li id="seconde_button"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle-1; ?>"><</a></li>
                    <li id="button1"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle; ?>"><?php echo $page_actuelle; ?></a></li>
                    <li id="button2"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+1; ?>"><?php echo $page_actuelle+1; ?></a></li>
                    <li id="button3"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $page_actuelle+2; ?>"><?php echo $page_actuelle+2; ?></a></li>
                    <li id="last_button"><a href="dm_au.php?lignes=<?php echo $nombre_ligne_affiche; ?>&amp;page=<?php echo $nombre_de_page; ?>">>></a></li>
                </ul>
                <div id="boutton_list" class="pull-right">
                    <a style="text-decoration: none; color: white;" href="dm_au.php?lignes=10&amp;page=1"><button id="button10" type="button" class="btn btn-info">10</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?lignes=20&amp;page=1"><button id="button20" type="button" class="btn btn-info">20</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?lignes=50&amp;page=1"><button id="button50" type="button" class="btn btn-info">50</button></a>
                    <a style="text-decoration: none; color: white;" href="dm_au.php?lignes=100&amp;page=1"><button id="button100" type="button" class="btn btn-info">100</button></a>
                </div>
            <?php }
            ?>
         <script>
